$( document ).ready(function() {
  ...
  $('.header-burger, .header-top-burger, .burger-back.close button').on('click', function() {
  ...
  if(btnView1) {
    btnView1.addEventListener('click', () => {
      const columns = document.querySelectorAll('.category-page-items .col-ss-12')
  ...
  if(btnView2) {
    btnView2.addEventListener('click', () => {
      const columns = document.querySelectorAll('.category-page-items .col-md-4')
